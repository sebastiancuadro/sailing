		...
		<div class="entry-content">
			...
			<?php
				...
				<div class="entry-summary">
					...
					the_excerpt();
					?>
					<?php if (isset($thim_options_data['thim_show_read_more']) && $thim_options_data['thim_show_read_more']) {?>
					<p class="learn-more"> <a href="<?php echo esc_url(get_permalink()) ?>"><?php echo esc_html__('Read More', 'sailing') ?></a> </p>
					<?php } ?>
				</div><!-- .entry-summary -->
			<?php }; ?>
		</div>
