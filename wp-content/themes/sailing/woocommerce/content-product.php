...
global $product, $woocommerce_loop, $thim_options_data, $wp_query;
...
if ( $thim_custom_column <> '' ) {
	...
	if ( isset( $thim_options_data['thim_woo_product_column'] ) && $thim_options_data['thim_woo_product_column'] <> '' ) {
		$thim_custom_column = $thim_options_data['thim_woo_product_column'];
		$column_product     = 12 / $thim_options_data['thim_woo_product_column'];
	}
}
...
<li <?php post_class( $classes ); ?>>
	<div class="content__product">
		...
		<div class="product_thumb">
			...
			?>
			<?php
			if ( isset( $thim_options_data['thim_woo_set_show_qv'] ) && $thim_options_data['thim_woo_set_show_qv'] == '1' ) {
