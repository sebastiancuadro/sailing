...
<div id="comments" class="comments-area<?php echo esc_attr( $class_has_comments ); ?>">
	...
	<div class="comment-respond-area">
		<?php comment_form( array(
				...
				'comment_field' => '<p class="comment-form-comment"><textarea placeholder="' . esc_attr__( 'Comment', 'sailing' ) . '" id="comment" name="comment" cols="45" rows="8" aria-required="true">' . '</textarea></p>'
		) ); ?>
	</div>
	<div class="clear"></div>
