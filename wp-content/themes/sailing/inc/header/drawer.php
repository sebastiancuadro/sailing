...
<div id="rt-drawer" class="<?php if ( isset( $thim_options_data['thim_drawer_style'] ) ) {
	echo esc_attr( $thim_options_data["thim_drawer_style"]);
} ?>">
	<div class="container">
		<div class="row">
			<?php
			if ( isset( $thim_options_data['thim_drawer_open'] ) && $thim_options_data['thim_drawer_open'] == 1 ) {
