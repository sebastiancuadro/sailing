...
if ( isset( $thim_options_data['thim_404_heading_bg_color'] ) && $thim_options_data['thim_404_heading_bg_color'] <> '' ) {
	$bg_color = $thim_options_data['thim_404_heading_bg_color'];
}

if ( isset( $thim_options_data['thim_404_top_image'] ) && $thim_options_data['thim_404_top_image'] <> '' ) {
	$cate_top_image     = $thim_options_data['thim_404_top_image'];
...
// show title and category
 if ( isset( $thim_options_data['thim_header_position'] ) && $thim_options_data['thim_header_position'] == 'header_overlay' ) {
	?>
