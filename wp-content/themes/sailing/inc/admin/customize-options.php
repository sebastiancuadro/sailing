...
class Thim_Customize_Options {
	...
	function create_customizer_options() {
		...
		include TP_THEME_DIR . "/inc/admin/customizer-sections/header-setting.php";
		...
		//include TP_THEME_DIR . "/inc/admin/customizer-sections/display-hotel-booking.php";
		...
		if ( class_exists( 'TP_Hotel_Booking' ) ) {
			include TP_THEME_DIR . "/inc/admin/customizer-sections/hotelbooking.php";
			include TP_THEME_DIR . "/inc/admin/customizer-sections/hotelbooking-archive.php";
			include TP_THEME_DIR . "/inc/admin/customizer-sections/hotelbooking-single.php";
			include TP_THEME_DIR . "/inc/admin/customizer-sections/hotelbooking-share.php";
		}
	...
	function generate_to_css() {
		...
		thim_themeoptions_variation( $options );
		thim_generate( TP_THEME_DIR . 'style', '.css', $options );
	}
}
