...
if ( !function_exists( 'thim_wrapper_layout' ) ) :
	function thim_wrapper_layout() {
		...
		if ( is_page() || is_single() ) {
			$postid = get_the_ID();
			if ( isset( $thim_options_data[$prefix . '_single_layout'] ) ) {
				$wrapper_layout = $thim_options_data[$prefix . '_single_layout'];
			}
			/***********custom layout*************/
			...
			if ( isset( $thim_options_data[$prefix . '_cate_layout'] ) ) {
				$wrapper_layout = $thim_options_data[$prefix . '_cate_layout'];
			}
			/***********custom layout*************/
